    ...
    for key, config in section_config.items():
        ...
        <section class="section" id="{key}">
            ...
            for i, item in enumerate(items, 1):
                ...
                # If has figure, add expandable image section
                if isinstance(item, dict) and item.get('has_figure') and page:
                    ...
                    html += f'''
                    <details class="figure-details" style="margin-top: 15px;">
                        <summary style="cursor: pointer; color: #fbbf24; font-size: 0.9rem; padding: 8px; background: rgba(251, 191, 36, 0.1); border-radius: 8px;">
                            📊 View {figure_ref} (Page {page}) - Click to expand
                        </summary>
                        <div style="margin-top: 10px; text-align: center; padding: 15px; background: #0f172a; border-radius: 8px;">
                            <img src="https://cardio-guidelines.onrender.com/api/page-image/{guideline_id}/{page}" 
                                 ...
                                 loading="lazy" />
                            <p style="margin-top: 10px; font-size: 0.8rem; color: #64748b;">{figure_ref} - Page {page}</p>
                        </div>
                    </details>'''
