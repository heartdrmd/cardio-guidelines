...
Extract EVERY recommendation. Look for Class I, IIa, IIb, III recommendations.

Return JSON:
{{"class_1": [{{"recommendation": "text", "loe": "A/B/C", "page": 1}}], "class_2a": [...], "class_2b": [...], "class_3": [...]}}

Rules: Extract EVERY recommendation with EXACT wording. Return ONLY valid JSON."""
